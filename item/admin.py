...
class ItemAdmin(admin.ModelAdmin):
    list_display = ('name', 'category', 'created_by', 'price', 'condition', 'status', 'admin_approved', 'views', 'favorites', 'created_at', 'get_image')
    list_filter = ('status', 'condition', 'admin_approved', 'is_featured', 'is_reported', 'category', 'created_at')
    ...
    fieldsets = (
        ...
        ('Status & Flags', {
            'fields': ('status', 'admin_approved', 'is_featured', 'is_urgent', 'is_negotiable', 'is_reported')
        }),
        ('Moderation', {
